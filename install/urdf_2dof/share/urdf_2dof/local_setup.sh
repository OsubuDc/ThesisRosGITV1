...
: ${AMENT_CURRENT_PREFIX:="/ThesisRosGITV1/install/urdf_2dof"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/urdf_2dof/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/urdf_2dof/environment/path.sh"
